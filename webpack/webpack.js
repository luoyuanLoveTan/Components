...
var _inputRange = __webpack_require__(27);
...
_reactDom2.default.render(_react2.default.createElement(_inputRange2.default, json), document.getElementById('root'));
...
var inputRange = function (_React$Component) {
    ...
    function inputRange(props) {
        ...
        _this.state = {
            currentValue: _this.props.data.currentValue || 3
        };
    ...
    _createClass(inputRange, [{
        ...
        value: function render() {
            ...
            var max = data.maxValue || 100;
            var min = data.minValue || 0;
            var step = data.stepValue || 1;
            var unit = data.unit || '';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'range', min: min, max: max, step: step, value: currentValue,
